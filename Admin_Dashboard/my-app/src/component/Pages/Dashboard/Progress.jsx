...
const Progress = () => {
  ...
  return (
    <div className="container m-5 ms-5 ps-5 mb-5 pb-5">
      <div className="cardA rounded bg-white border d-flex flex-column shadow ms-5 p-2 pb-0 mb-0" style={{ maxWidth: '500px', width: '90vw' }}>
        <h2 className='m-3 text-bold font-monospace text-center'>Progress Status</h2>
        <div  style={{ display: 'flex', width: '100%' }}>
          <div className='ms-3 pb-0 mb-0' style={{ flex: 1, width: '539px', height:'439px' }}>
