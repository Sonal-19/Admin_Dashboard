    ...
    <>
      <div className='sidebar col-2 mt-5' >
        ...
        {activeSection === 'product' && (
          ...
          <div className='sub-menu sidebar-section'>
            <Link to="/productlist" className="sub-menu-link">
              Product List
            </Link>
          </div>
		      <div className='sub-menu sidebar-section'>
        ...
        {activeSection === 'user account' && (
          <>
          <div className='sub-menu sidebar-section'>
            <Link to="/userlist" className='sub-menu-link'>User List</Link>
          </div>
          <div className='sub-menu sidebar-section'>
        ...
        {activeSection === 'admin account' && (
          <>
          <div className='sub-menu sidebar-section'>
            <Link to="/adminlist" className='sub-menu-link'>Admin List</Link>
          </div>
          <div className='sub-menu sidebar-section'>
            <Link to="/addadmin" className='sub-menu-link'>Add New Admin</Link>
          </div>
          </>
        )}
      ...
      <div className="sidebar-section"
        ...
        <div className="sidebar-section"
            ...
            <>
            <div className='sub-menu sidebar-section'>
              <Link to="/bloglist" className='sub-menu-link'>Blog List</Link>
            </div>
            <div className='sub-menu sidebar-section'>
        ...
        <div className="sidebar-section"
            ...
            <>
            <div className='sub-menu sidebar-section'>
              <Link to="/signup" className='sub-menu-link'>Sign Up</Link>
            </div>
            <div className='sub-menu sidebar-section'>
              <Link to="/login" className='sub-menu-link'>Login </Link>
            </div>
            <div className='sub-menu sidebar-section'>
              <Link to="/forget" className='sub-menu-link'>Forget Password</Link>
            </div>
            </>
            )}
        ...
        <div className="sidebar-section"
          onClick={() => handleToggle('todo')}>
          <Link to="/contactlist" className='section-link'>
